    ...
    return (
        <div className="fixed bottom-5 left-1/2 translate-x-[-50%] z-10">
            <Dock direction="middle">
                ...
                <DockIcon>
                    <Icons.github className="size-10 box-border p-2 rounded-full hover:bg-gray-100 duration-300" />
                </DockIcon>
                <DockIcon>
                    <Icons.linkedin className="size-10 box-border p-2 rounded-full hover:bg-gray-100 duration-300" />
                </DockIcon>
            </Dock>
        </div>
    );
